...
| --- | --- | ---: | ---: |
| `batchCargaBaseDadosIndicadorAlfabetizacao` | Sete tabelas BigQuery para Bronze | 1024 MB | 900 s |
| `batchCargaTabelaMunicipioIBGE` | API IBGE para Bronze | 128 MB | 60 s |
| `streamMetaAlfabetizacaoBrasil` | API/EventBridge para Bronze e inicia Step Functions | 128 MB | 63 s |
...
A função `batchCargaBaseDadosIndicadorAlfabetizacao` lê as credenciais do Google BigQuery no AWS Systems Manager
